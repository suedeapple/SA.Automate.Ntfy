...
/// <summary>
/// Defines the public, unauthenticated ntfy connection type for Umbraco Automate.
/// Stores the topic (and an optional server override) per connection, and validates
/// reachability against the ntfy server before saving.
/// </summary>
[ConnectionType("ntfy", "ntfy",
    Description = "Connect to a public ntfy topic",
    Group = "Messaging",
    Icon = "icon-plugin")]
public sealed class NtfyConnectionType : ConnectionTypeBase<NtfyConnectionSettings>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await NtfyRequestHelper.ValidateTopicAsync(client, serverUrl, typed.Topic, null, cancellationToken);
    }
}
